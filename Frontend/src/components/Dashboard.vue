        ...
        <mdb-col xl="3" md="6" class="mb-r">
          <mdb-card cascade class="cascading-admin-card">
            ...
            <mdb-card-body>
              ...
              <mdb-card-text>Producción semanale 50/200</mdb-card-text>
            </mdb-card-body>
          </mdb-card>
        </mdb-col>
        <mdb-col xl="3" md="6" class="mb-r">
          <mdb-card cascade class="cascading-admin-card">
            ...
            <mdb-card-body>
              ...
              <mdb-card-text>Actividades semanales (75%)</mdb-card-text>
            </mdb-card-body>
          </mdb-card>
        </mdb-col>
        <mdb-col xl="3" md="6" class="mb-r">
          <mdb-card cascade class="cascading-admin-card">
            ...
            <mdb-card-body>
              ...
              <mdb-card-text>Lotes activos 20/40 (50%)</mdb-card-text>
            </mdb-card-body>
          </mdb-card>
        </mdb-col>
      </mdb-row>
    ...
    <section>
      <mdb-row>
        <mdb-col lg="6" class="mb-4">
          <mdb-card>
            <mdb-card-header>Distribución de Lotes</mdb-card-header>
            <mdb-card-body>
              <GmapMap
